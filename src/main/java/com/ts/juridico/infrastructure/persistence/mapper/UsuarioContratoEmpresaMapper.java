...
public class UsuarioContratoEmpresaMapper {
    ...
    public UsuarioContratoEmpresa dtoToModel(UsuarioProcessoCadastroDto dto) {
        ...
        return UsuarioContratoEmpresa.builder()
                .cargo(dto.getCargo())
                .dataAdmissao(LocalDate.parse(dto.getDataAdmissao(), formatter))
                .dataDemissao(LocalDate.parse(dto.getDataDemissao(), formatter))
                .dataAvisoPrevio(LocalDate.parse(dto.getDataAvisoPrevio(), formatter))
